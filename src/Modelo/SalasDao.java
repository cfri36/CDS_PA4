    ...
    public Connection ListarSalas() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                int mesas = rs.getInt(3);
                System.out.println("Id Mesa: " + id);
                System.out.println("Nombre de sala: " + nombre);
                System.out.println("Mesa: " + mesas);
            }
            JOptionPane.showMessageDialog(null, "Conexión Exitosa Modulo Distribucion Mesas y Salas");
        } catch (SQLException e) {
            System.out.println(e.toString());
        }
        return con;
